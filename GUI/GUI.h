...
public:
	...
	//void UpdateStatusBar(int TimeStep, double castlehealth, CASTLE_STAT FROZ);
	void UpdateStatusBar(int TimeStep, double castlehealth, CASTLE_STAT FROZ, int ActiveFighters, int ActiveHealers, int ActiveFreezers, int ActiveCount,
	...
	void UpdateInterface(int TimeStep, double castlehealth, CASTLE_STAT FROZ, int ActiveFighters, int ActiveHealers, int ActiveFreezers, int ActiveCount,
		int FrozenFighters, int FrozenHealers, int FrozenFreezers, int FrostedCount,
		int KilledFighters, int KilledFreezers, int KilledHealers, int KilledCount);
	//void UpdateInterface(int TimeStep, double castlehealth, CASTLE_STAT FROZ);	//prints info on status bar. Info includes timestep and other enemies info as illustrated in project doc
